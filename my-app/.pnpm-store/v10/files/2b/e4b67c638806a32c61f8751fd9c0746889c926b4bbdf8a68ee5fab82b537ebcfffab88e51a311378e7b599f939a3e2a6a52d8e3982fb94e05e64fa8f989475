...
/** @internal */
export const TransferIntent$inboundSchema = z.object({
...
/** @internal */
export const Web3Data$inboundSchema = z.object({
...
/** @internal */
export const CreateCoinbaseChargeData$inboundSchema = z.object({
    id: z.string(),
    created_at: z.string(),
    expires_at: z.string(),
...
//# sourceMappingURL=createcoinbasecharge.js.map