...
import type { DefaultEngineType, DynamicMapping, ExtractSchemaFromStep, ExtractSchemaType, PathsToStringProps, SerializedStepFlowEntry, StepFlowEntry, StepResult, StepsRecord, StepWithComponent, StreamEvent, SubsetOf, WatchEvent, TimeTravelContext, WorkflowConfig, WorkflowEngineType, WorkflowOptions, WorkflowResult, WorkflowRunStatus, WorkflowState, WorkflowStreamEvent } from './types.js';
type AgentStepOptions = Omit<AgentExecutionOptions & AgentStreamOptions, 'format' | 'tracingContext' | 'runtimeContext' | 'abortSignal' | 'context' | 'onStepFinish' | 'output' | 'experimental_output' | 'resourceId' | 'threadId'>;
...
export declare function createStep<TStepId extends string, TStepInput extends z.ZodObject<{
    ...
    text: z.ZodString;
}>, TResumeSchema extends z.ZodType<any>, TSuspendSchema extends z.ZodType<any>>(agent: Agent<TStepId, any, any>, agentOptions?: AgentStepOptions): Step<TStepId, any, TStepInput, TStepOutput, TResumeSchema, TSuspendSchema, DefaultEngineType>;
...
export declare class Workflow<TEngineType = any, TSteps extends Step<string, any, any, any, any, any, TEngineType>[] = Step<string, any, any, any, any, any, TEngineType>[], TWorkflowId extends string = string, TState extends z.ZodObject<any> = z.ZodObject<any>, TInput extends z.ZodType<any> = z.ZodType<any>, TOutput extends z.ZodType<any> = z.ZodType<any>, TPrevSchema extends z.ZodType<any> = TInput> extends MastraBase implements Step<TWorkflowId, TState, TInput, TOutput, any, any, DefaultEngineType> {
    ...
    get options(): Omit<WorkflowOptions, "shouldPersistSnapshot" | "validateInputs"> & Required<Pick<WorkflowOptions, "shouldPersistSnapshot" | "validateInputs">>;
     ...
     */
    then<TStepId extends string, TStepState extends z.ZodObject<any>, TStepInputSchema extends z.ZodType<any>, TSchemaOut extends z.ZodType<any>>(step: Step<TStepId, SubsetOf<TStepState, TState>, z.TypeOf<TPrevSchema> extends z.TypeOf<TStepInputSchema> ? TStepInputSchema : never, TSchemaOut, any, any, TEngineType>): Workflow<TEngineType, TSteps, TWorkflowId, TState, TInput, TOutput, TSchemaOut>;
    /**
    ...
    parallel<TParallelSteps extends readonly Step<string, any, TPrevSchema, any, any, any, TEngineType>[]>(steps: TParallelSteps & {
        [K in keyof TParallelSteps]: TParallelSteps[K] extends Step<string, infer S extends z.ZodObject<any>, TPrevSchema, infer O, any, // Don't infer TResumeSchema - causes issues with heterogeneous tuples
    ...
    execute({ runId, inputData, resumeData, state, setState, suspend, restart, resume, timeTravel, [EMITTER_SYMBOL]: emitter, mastra, runtimeContext, abort, abortSignal, runCount, tracingContext, writer, validateInputs, }: {
        runId?: string;
    ...
    getWorkflowRuns(args?: StorageListWorkflowRunsInput): Promise<import("..").WorkflowRuns>;
    getActiveWorkflowRuns(): Promise<{
        runs: WorkflowRun[];
        total: number;
    }>;
    ...
    getWorkflowRunExecutionResult(runId: string, withNestedWorkflows?: boolean): Promise<WorkflowState | null>;
}
/**
...
export declare class Run<TEngineType = any, TSteps extends Step<string, any, any, any, any, any, TEngineType>[] = Step<string, any, any, any, any, any, TEngineType>[], TState extends z.ZodObject<any> = z.ZodObject<any>, TInput extends z.ZodType<any> = z.ZodType<any>, TOutput extends z.ZodType<any> = z.ZodType<any>> {
    ...
    protected _validateTimetravelInputData<TInputSchema extends z.ZodType<any>>(inputData: z.input<TInputSchema>, step: Step<string, any, TInputSchema, any, any, any, TEngineType>): Promise<z.input<TInputSchema>>;
     ...
     * @returns A promise that resolves to the workflow output
     */
    streamVNext({ inputData, runtimeContext, tracingContext, tracingOptions, closeOnSuspend, initialState, }?: {
        inputData?: z.input<TInput>;
        runtimeContext?: RuntimeContext;
        tracingContext?: TracingContext;
        tracingOptions?: TracingOptions;
    ...
    watchAsync(cb: (event: WatchEvent) => void, type: 'watch'): Promise<() => void>;
    watchAsync(cb: (event: WorkflowStreamEvent) => void, type: 'watch-v2'): Promise<() => void>;
    ...
    protected _restart({ runtimeContext, writableStream, tracingContext, tracingOptions, }: {
        runtimeContext?: RuntimeContext;
        writableStream?: WritableStream<ChunkType>;
        tracingContext?: TracingContext;
        tracingOptions?: TracingOptions;
    }): Promise<WorkflowResult<TState, TInput, TOutput, TSteps>>;
    protected _timeTravel<TInputSchema extends z.ZodType<any>>({ inputData, resumeData, initialState, step: stepParam, context, nestedStepsContext, runtimeContext, writableStream, tracingContext, tracingOptions, outputOptions, }: {
    ...
    timeTravel<TInputSchema extends z.ZodType<any>>(args: {
        inputData?: z.input<TInputSchema>;
        resumeData?: any;
        initialState?: z.input<TState>;
        step: Step<string, any, TInputSchema, any, any, any, TEngineType> | [
    ...
    timeTravelStream<TInputSchema extends z.ZodType<any>>({ inputData, resumeData, initialState, step, context, nestedStepsContext, runtimeContext, tracingContext, tracingOptions, outputOptions, }: {
        inputData?: z.input<TInputSchema>;
        initialState?: z.input<TState>;
        resumeData?: any;
        step: Step<string, any, TInputSchema, any, any, any, TEngineType> | [
