...
var MemoryProcessor = class extends chunk6VOPKVYH_cjs.MastraBase {
  /**
...
var MastraMemory = class extends chunk6VOPKVYH_cjs.MastraBase {
  MAX_CONTEXT_TOKENS;
  _storage;
  vector;
  embedder;
...
https://mastra.ai/en/docs/memory/semantic-recall`
      ...
      if (typeof config.embedder === "string") {
        this.embedder = new chunk22DLIF7L_cjs.ModelRouterEmbeddingModel(config.embedder);
      } else {
