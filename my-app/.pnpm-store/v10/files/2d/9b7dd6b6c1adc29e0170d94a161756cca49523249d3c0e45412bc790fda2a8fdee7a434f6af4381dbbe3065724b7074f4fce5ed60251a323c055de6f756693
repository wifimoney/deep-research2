...
import type { LanguageModelV2FinishReason, LanguageModelV2Usage, SharedV2ProviderMetadata, LanguageModelV2CallWarning, LanguageModelV2ResponseMetadata, LanguageModelV2StreamPart } from '@ai-sdk/provider-v5';
...
import type { InferSchemaOutput, OutputSchema, PartialSchemaOutput } from './base/schema.js';
...
export type NetworkChunkType = (BaseChunkType & {
...
export type AgentChunkType<OUTPUT extends OutputSchema = undefined> = (BaseChunkType & {
...
export type TypedChunkType<OUTPUT extends OutputSchema = undefined> = AgentChunkType<OUTPUT> | WorkflowStreamEvent | NetworkChunkType | (DataChunkType & {
    from: never;
    runId: never;
...
export type MastraOnStepFinishCallback = (event: LLMStepResult & {
    model?: partialModel;
    runId?: string;
}) => Promise<void> | void;
