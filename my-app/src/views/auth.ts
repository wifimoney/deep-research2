  ...
  return html`
    ...
    <body>
      <div class="auth-container">
        ...
        <a href="/api/auth/sign-in/google" style="display: block; text-decoration: none;">
          <button type="button" style="background: white; color: #333; border: 2px solid #e0e0e0; display: flex; align-items: center; justify-content: center; gap: 12px; width: 100%; padding: 14px; border-radius: 8px; font-size: 16px; font-weight: 500; cursor: pointer; transition: all 0.2s;">
