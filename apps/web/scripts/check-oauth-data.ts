...
async function checkOAuthData() {
  try {
    ...
    console.log('Recent users:', users.rows.length);
    ...
    console.log('\nRecent OAuth accounts:', accounts.rows.length);
    accounts.rows.forEach((account: any) => {
    ...
    console.log('\nRecent sessions:', sessions.rows.length);
    sessions.rows.forEach((session: any) => {
    ...
    console.log('\nRecent verifications:', verifications.rows.length);
