...
import { renderLoginPage, renderRegisterPage } from '../ui/auth-views.js'
import {
    createUser,
    findUserByEmail,
    findUserByUsername,
...
import { redirectIfAuthenticated } from '../../../shared/auth/middleware.js'
import { getSession, auth as betterAuthInstance } from '../../../shared/auth/index.js'
